    ...
    <div className="text-white font-sans pointer-events-none">
      ...
      <main className="my-10 md:mt-20 md:mb-10 px-10 md:px-0 md:w-1/2 mx-auto">
        <section className="flex flex-col space-y-5">
          ...
          <p className="p">I'm not looking for work at the moment. I currently interact with friends at <a className="a" href="https://hackclub.com" target="_blank">Hack Club</a>. You can hire me competitively starting <b>Summer 2022</b>. You can contact me at my social media linked below or at <a className="pointer-events-auto" href="mailto:sarthak@sarthakmohanty.me" target="_blank">sarthak@sarthakmohanty.me</a>. Thanks for being here.</p>
