    ...
    <div className="text-white pointer-events-none">
      ...
      <main className="my-10 md:mt-20 md:mb-10 px-10 md:px-0 md:w-1/2 mx-auto">
        <section className="flex flex-col space-y-5">
          ...
          <p className="p">I'm not looking for work at the moment. I currently work at <a className="a" href="https://mintere.com" target="_blank">Mintere</a> and interact with friends at <a className="a" href="https://hackclub.com" target="_blank">Hack Club</a>. You can hire me competitively starting <b>Summer 2021</b>. You can contact me at my social media linked below or at <a className="pointer-events-none" href="mailto:sarthak@sarthakmohanty.me" target="_blank">sarthak@sarthakmohanty.me</a>. Thanks for being here.</p>
          <details className="pointer-events-auto pb-10">
            ...
            <li><a href="https://github.com/sarthaktexas" target="_blank">GitHub</a>, <a href="https://dribbble.com/sarthaktexas">Dribbble</a></li>
